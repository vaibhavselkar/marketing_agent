...
const plans = [
  {
    ...
    period: '/month',
    color: '#6366f1',
    features: ['WhatsApp automation', 'Email campaigns', '1,000 messages/month', 'Lead CRM (Google Sheets)', 'Analytics dashboard'],
  ...
  },
  {
    ...
    period: '/month',
    color: '#8b5cf6',
    features: ['Everything in Starter', 'Instagram DM bot', 'Festival campaigns', 'Re-engagement sequences', 'Priority support'],
